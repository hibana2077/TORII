...
4. Compute bidirectional transport alignment losses:
   - node alignment
   - edge consistency
   - optional learnable transport matrix optimization (gradient descent)
5. Compare same-class and different-class image pairs.
...
- CSV also includes `transport_mode`
